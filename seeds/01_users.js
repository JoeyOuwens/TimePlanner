    ...
    .then(function () {
      // Inserts seed entries
        return knex('users').insert([
            ...
            { id: 3, password: 'aPlainTextPassword', firstname: 'Berry', lastname: 'Boss', email: 'BBoss@gmail.com', employed_since: "2009-01-16", birth_date: "1929-7-1", address: 'RestaurantRoad 2A', zip: '1133AB', place: 'Everywhere', contract_hours: 32, phone_number: '643423537', function: 'Owner', role: 'OWNER'}
